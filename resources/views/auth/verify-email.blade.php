...
<html lang="en">
  <head>
    ...
    <title>HaloSurat - Verify Email</title>
          ...
          <div class="col-lg-8">
            <div class="card-group d-block d-md-flex row">
              <div class="card col-md-12 p-4 mb-0">
                <div class="card-body">
                  <h1>Verify Email</h1>
                  <p class="text-body-secondary">Thanks for signing up! Before getting started, please verify your email address by clicking on the link we just emailed to you. If you didn't receive the email, we will gladly send you another.</p>
                  ...
                  <form method="POST" action="{{ route('verification.send') }}">
                    ...
                    <div class="row mt-4">
                      <div class="col-12">
                        <button class="btn btn-primary px-4" type="submit">Resend Verification Email</button>
                      </div>
                    </div>
                  </form>
                  ...
                  <form method="POST" action="{{ route('logout') }}" class="mt-3">
                    ...
                    <div class="row">
                      <div class="col-12">
                        <button class="btn btn-link px-0" type="submit">Log Out</button>
                      </div>
                    </div>
                  </form>
                </div>
