...
<html lang="en">
  <head>
    ...
    <title>HaloSurat - Confirm Password</title>
            ...
            <div class="card-group d-block d-md-flex row">
              <div class="card col-md-12 p-4 mb-0">
                <div class="card-body">
                  ...
                  <p class="text-body-secondary">This is a secure area of the application. Please confirm your password before continuing.</p>
