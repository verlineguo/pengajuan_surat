<div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
  ...
  <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
    <li class="nav-item"><a class="nav-link" href="{{ route('mahasiswa.dashboard') }}">
        <svg class="nav-icon">
    ...
    <li class="nav-title" data-coreui-i18n="theme">Pengajuan</li>
    <li class="nav-item"><a class="nav-link" href="{{ route('mahasiswa.pengajuan') }}">
        <svg class="nav-icon">
          <use xlink:href="{{ asset('template') }}/vendors/@coreui/icons/svg/free.svg#cil-drop"></use>
        </svg><span data-coreui-i18n="colors">Pengajuan Surat</span></a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('mahasiswa.pengajuan.history') }}">
        <svg class="nav-icon">
          <use xlink:href="{{ asset('template') }}/vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
        </svg><span data-coreui-i18n="typography">Histori Pengajuan</span></a></li>
