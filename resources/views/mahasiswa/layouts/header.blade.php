    ...
    <ul class="header-nav ms-auto ms-md-0">
      ...
      <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu dropdown-menu-end pt-0">
          ...
          <div class="dropdown-header bg-body-tertiary text-body-secondary fw-semibold my-2" data-coreui-i18n="settings">Settings</div><a class="dropdown-item" href={{ route('mahasiswa.pengajuan') }}>  
            <a class="dropdown-item" href="{{ route('profile', ['role' => 'mahasiswa']) }}"> <svg class="icon me-2">
