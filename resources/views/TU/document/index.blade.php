        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('tu.pengajuan.show', $pengajuan->id_pengajuan) }}" class="btn btn-info"  style="background-color: #53BCE9">
                        <i class="fas fa-eye"></i>
                    </a>

                    @if ($pengajuan->status_pengajuan == 'pending')
                        <a href="{{ route('tu.pengajuan.approve', $pengajuan->id_pengajuan) }}" class="btn" style="background-color: #47C97F; color: #000000">
                            <i class="fas fa-check-circle"></i>
                        </a>
                        <a href="{{ route('tu.pengajuan.reject', $pengajuan->id_pengajuan) }}" class="btn btn-danger" style="background-color: #FA3F68">
                            <i class="fas fa-times-circle"></i>
                        </a>
                    @endif

                    <form action="{{ route('tu.pengajuan.destroy', $pengajuan->id_pengajuan) }}" method="POST" style="display:inline; background-color: #FBB65F;">
                        @csrf
                        @method('DELETE')
